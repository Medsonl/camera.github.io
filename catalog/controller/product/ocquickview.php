    ...
    public function loadProduct($product_id) {
        ...
        if($product_info) {
            ...
            if($use_zoom) {
                ...
                if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/oc_css/zoom.css')) {
                    $this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/oc_css/zoom.css');
                } else {
