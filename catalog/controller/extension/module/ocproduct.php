...
class ControllerExtensionModuleOcProduct extends Controller {
	public function index($setting) {
		...
		$this->document->addScript('catalog/view/javascript/opentheme/countdown/jquery.plugin.js');
		$this->document->addScript('catalog/view/javascript/opentheme/countdown/jquery.countdown.js');
