...
class ControllerExtensionModuleOcmegamenu extends Controller
{
    public function index($setting) {
        ...
        // if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/oc_css/menu.css')) {
            // $this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/oc_css/menu.css');
        // } 
		// else {
            // $this->document->addStyle('catalog/view/theme/default/stylesheet/oc_css/menu.css');
        // }
