...
class ControllerExtensionModuleOcslideshow extends Controller {
	public function index($setting) { 
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('theme_' . $this->config->get('config_theme') . '_directory') . '/stylesheet/oc_css/ocslideshow.css')) {
			$this->document->addStyle('catalog/view/theme/'.$this->config->get('theme_' . $this->config->get('config_theme') . '_directory').'/stylesheet/oc_css/ocslideshow.css');
		} else {
			$this->document->addStyle('catalog/view/theme/default/stylesheet/oc_css/ocslideshow.css');
		}
